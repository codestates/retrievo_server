import { MailerIFC } from "../services/mailerService";

const generateInvitationHtml = (userInfo: MailerIFC): string => {
  return `  
  <div
...
>
  <div style="background-color: #31d5bf; width: 100%; padding: 2rem 0">
    <p style="margin-top: 1rem; color: #ff55da; text-align: center">
      Woof Woof!
    </p>
    <p
      style="
  ...
  <div>
    ...
    >
      <strong style="color: black; font-size: 1.3rem"
        >${userInfo.senderName}</strong
      >
      sent you an invitation to work on the
      <strong style="color: black; font-size: 1.3rem"
        >${userInfo.projectName}</strong
      >
      project together!
    </p>
    <p
